...
$workdir = "D:\FLAC_AI\3D_small\0531\2896"
$script = Join-Path $workdir "run_read_far_boundary_sub_2896_logged.f3dat"
$status = Join-Path $workdir "out\read_far_boundary_sub_2896_status.txt"
